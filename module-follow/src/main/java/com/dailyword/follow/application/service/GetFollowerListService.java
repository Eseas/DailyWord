...
/**
 * 특정 사용자를 팔로우하는 사용자 목록을 조회하는 서비스입니다.
 *
 * 페이지네이션을 지원하여 팔로워 목록을 20개씩 나눠서 조회합니다.
 * FOLLOWING 상태의 관계만을 대상으로 하여 활성 상태의 팔로워만 반환합니다.
 *
...
public class GetFollowerListService implements GetFollowerListUsecase {
    ...
    /**
     * 특정 사용자를 팔로우하는 사용자들의 목록을 페이지네이션으로 조회합니다.
     *
     * 해당 사용자를 팔로우하는 사용자들의 정보를 페이지 단위로 조회합니다.
     * 한 페이지당 20개의 데이터를 반환하며, FOLLOWING 상태의 관계만을 대상으로 합니다.
     *
     * @param memberId 팔로워 목록을 조회할 대상 사용자의 ID
     * @param page 조회할 페이지 번호 (0부터 시작)
     * @return 팔로워 목록과 페이지 정보를 포함한 응답
     */
    @Override
